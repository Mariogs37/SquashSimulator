...
Hamilton = Team.create(:name => 'Hamilton', :team_id => 7714)
Stanford = Team.create(:name => 'Stanford', :team_id => 7705)
Colby = Team.create(:name => 'Colby', :team_id => 7688)
Bucknell = Team.create(:name => 'Bucknell', :team_id => 7740)
Georgetown = Team.create(:name => 'Georgetown', :team_id => 7719)
Hobart = Team.create(:name => 'Hobart', :team_id => 7708)
Tufts = Team.create(:name => 'Tufts', :team_id => 7726)
JHU = Team.create(:name => 'JHU', :team_id => 7743)
Haverford = Team.create(:name => 'Haverford', :team_id => 7715)
BC = Team.create(:name => 'BC', :team_id => 7692)
BU = Team.create(:name => 'BU', :team_id => 7734)
Denison = Team.create(:name => 'Denison', :team_id => 7707)
UVA = Team.create(:name => 'UVA', :team_id => 7723)
WashU = Team.create(:name => 'WashU', :team_id => 7750)
MIT = Team.create(:name => 'MIT', :team_id => 7706)
Colgate = Team.create(:name => 'Colgate', :team_id => 7709)
Washington = Team.create(:name => 'Bowdoin', :team_id => 7686)
